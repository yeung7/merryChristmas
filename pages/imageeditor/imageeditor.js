// pages/imageeditor/imageeditor.js
const app=getApp()
...
Page({
  ...
  touchStart(e){
    ...
    if(this.touch_target!=""){
      this.target_x=e.touches[0].clinetX;
      this.target_y=e.touches[0].clinetY;
    }
  },
  ...
  touchMove(e){
    var current_x=e.touches[0].clinetX;
    var current_y=e.touches[0].clinetY;
